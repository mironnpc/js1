...
function startChessGame () {
    ...
    //Раставляем фигуры
    objChessInGame.addChess("A1", "torre-w");
    objChessInGame.addChess("B1", "caballo-w");
    objChessInGame.addChess("C1", "alfil-w");
    objChessInGame.addChess("D1", "rey-w");
    objChessInGame.addChess("E1", "reina-w");
    objChessInGame.addChess("F1", "alfil-w");
    objChessInGame.addChess("G1", "caballo-w");
    objChessInGame.addChess("H1", "torre-w");
    ...
    objChessInGame.addChess("A8", "torre-b");
    objChessInGame.addChess("B8", "caballo-b");
    objChessInGame.addChess("C8", "alfil-b");
    objChessInGame.addChess("D8", "rey-b");
    objChessInGame.addChess("E8", "reina-b");
    objChessInGame.addChess("F8", "alfil-b");
    objChessInGame.addChess("G8", "caballo-b");
    objChessInGame.addChess("H8", "torre-b");
